...
bool dsr_msgs2__msg__robot_error__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dsr_msgs2.msg._robot_error.RobotError", full_classname_dest, 37) == 0);
  }
  dsr_msgs2__msg__RobotError * ros_message = _ros_message;
  {  // level
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dsr_msgs2__msg__robot_error__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RobotError */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dsr_msgs2.msg._robot_error");
  ...
  dsr_msgs2__msg__RobotError * ros_message = (dsr_msgs2__msg__RobotError *)raw_ros_message;
  {  // level
    PyObject * field = NULL;
