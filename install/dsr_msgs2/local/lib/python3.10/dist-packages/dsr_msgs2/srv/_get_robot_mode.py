...
class Metaclass_GetRobotMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _get_robot_mode
...
class GetRobotMode(metaclass=Metaclass_GetRobotMode):
    from dsr_msgs2.srv._get_robot_mode import GetRobotMode_Request as Request
    from dsr_msgs2.srv._get_robot_mode import GetRobotMode_Response as Response
