...
bool dsr_msgs2__srv__move_spline_task__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dsr_msgs2.srv._move_spline_task.MoveSplineTask_Request", full_classname_dest, 54) == 0);
  }
  dsr_msgs2__srv__MoveSplineTask_Request * ros_message = _ros_message;
  {  // pos
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dsr_msgs2__srv__move_spline_task__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveSplineTask_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dsr_msgs2.srv._move_spline_task");
  ...
  dsr_msgs2__srv__MoveSplineTask_Request * ros_message = (dsr_msgs2__srv__MoveSplineTask_Request *)raw_ros_message;
  {  // pos
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool dsr_msgs2__srv__move_spline_task__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dsr_msgs2.srv._move_spline_task.MoveSplineTask_Response", full_classname_dest, 55) == 0);
  }
  dsr_msgs2__srv__MoveSplineTask_Response * ros_message = _ros_message;
  {  // success
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dsr_msgs2__srv__move_spline_task__response__convert_to_py(void * raw_ros_message)
{
  ...
  dsr_msgs2__srv__MoveSplineTask_Response * ros_message = (dsr_msgs2__srv__MoveSplineTask_Response *)raw_ros_message;
  {  // success
    PyObject * field = NULL;
