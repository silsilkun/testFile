...
class Metaclass_GetUserCartCoord(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dsr_msgs2.srv.GetUserCartCoord')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dsr_msgs2.srv import _get_user_cart_coord
...
class GetUserCartCoord(metaclass=Metaclass_GetUserCartCoord):
    from dsr_msgs2.srv._get_user_cart_coord import GetUserCartCoord_Request as Request
    from dsr_msgs2.srv._get_user_cart_coord import GetUserCartCoord_Response as Response
