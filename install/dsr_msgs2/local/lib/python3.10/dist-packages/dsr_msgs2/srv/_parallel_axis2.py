...
class Metaclass_ParallelAxis2(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _parallel_axis2
...
class ParallelAxis2(metaclass=Metaclass_ParallelAxis2):
    from dsr_msgs2.srv._parallel_axis2 import ParallelAxis2_Request as Request
    from dsr_msgs2.srv._parallel_axis2 import ParallelAxis2_Response as Response
