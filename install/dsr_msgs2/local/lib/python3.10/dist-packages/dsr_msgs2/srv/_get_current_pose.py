...
class Metaclass_GetCurrentPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _get_current_pose
...
class GetCurrentPose(metaclass=Metaclass_GetCurrentPose):
    from dsr_msgs2.srv._get_current_pose import GetCurrentPose_Request as Request
    from dsr_msgs2.srv._get_current_pose import GetCurrentPose_Response as Response
