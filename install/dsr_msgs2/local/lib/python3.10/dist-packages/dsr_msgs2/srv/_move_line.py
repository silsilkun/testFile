...
class Metaclass_MoveLine(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _move_line
...
class MoveLine(metaclass=Metaclass_MoveLine):
    from dsr_msgs2.srv._move_line import MoveLine_Request as Request
    from dsr_msgs2.srv._move_line import MoveLine_Response as Response
