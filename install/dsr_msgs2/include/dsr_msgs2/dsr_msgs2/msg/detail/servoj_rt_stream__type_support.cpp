...
{
  new (message_memory) dsr_msgs2::msg::ServojRtStream(_init);
}

void ServojRtStream_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dsr_msgs2::msg::ServojRtStream *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServojRtStream_message_member_array[4] = {
  {
    ...
    offsetof(dsr_msgs2::msg::ServojRtStream, pos),  // bytes offset in struct
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(dsr_msgs2::msg::ServojRtStream, vel),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(dsr_msgs2::msg::ServojRtStream, acc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dsr_msgs2::msg::ServojRtStream, time),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServojRtStream_message_members = {
  ...
  4,  // number of fields
  sizeof(dsr_msgs2::msg::ServojRtStream),
...
get_message_type_support_handle<dsr_msgs2::msg::ServojRtStream>()
{
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::ServojRtStream_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, msg, ServojRtStream)() {
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::ServojRtStream_message_type_support_handle;
}
