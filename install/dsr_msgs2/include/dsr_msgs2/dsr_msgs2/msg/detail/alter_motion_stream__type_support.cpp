...
{
  new (message_memory) dsr_msgs2::msg::AlterMotionStream(_init);
}

void AlterMotionStream_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dsr_msgs2::msg::AlterMotionStream *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AlterMotionStream_message_member_array[1] = {
  {
    ...
    offsetof(dsr_msgs2::msg::AlterMotionStream, pos),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AlterMotionStream_message_members = {
  ...
  1,  // number of fields
  sizeof(dsr_msgs2::msg::AlterMotionStream),
...
{
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::AlterMotionStream_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, msg, AlterMotionStream)() {
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::AlterMotionStream_message_type_support_handle;
}
