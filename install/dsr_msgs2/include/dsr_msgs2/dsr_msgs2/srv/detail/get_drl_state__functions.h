...
#ifndef DSR_MSGS2__SRV__DETAIL__GET_DRL_STATE__FUNCTIONS_H_
#define DSR_MSGS2__SRV__DETAIL__GET_DRL_STATE__FUNCTIONS_H_
 ...
 * calls
 * dsr_msgs2__srv__GetDrlState_Request__init().
...
/**
 * It calls
 * dsr_msgs2__srv__GetDrlState_Request__fini()
 ...
 * dsr_msgs2__srv__GetDrlState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dsr_msgs2__srv__GetDrlState_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dsr_msgs2__srv__GetDrlState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dsr_msgs2
...
/**
 * It calls
 * dsr_msgs2__srv__GetDrlState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dsr_msgs2
...
/**
 * It allocates the memory for the array and calls
 * dsr_msgs2__srv__GetDrlState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dsr_msgs2
...
/**
 * It calls
 * dsr_msgs2__srv__GetDrlState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DSR_MSGS2__SRV__DETAIL__GET_DRL_STATE__FUNCTIONS_H_
