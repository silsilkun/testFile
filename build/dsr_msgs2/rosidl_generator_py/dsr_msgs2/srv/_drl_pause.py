...
class Metaclass_DrlPause(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _drl_pause
...
class DrlPause(metaclass=Metaclass_DrlPause):
    from dsr_msgs2.srv._drl_pause import DrlPause_Request as Request
    from dsr_msgs2.srv._drl_pause import DrlPause_Response as Response
