...
class Metaclass_MoveSplineTask(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _move_spline_task
...
class MoveSplineTask(metaclass=Metaclass_MoveSplineTask):
    from dsr_msgs2.srv._move_spline_task import MoveSplineTask_Request as Request
    from dsr_msgs2.srv._move_spline_task import MoveSplineTask_Response as Response
