...
class Metaclass_MoveHome(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _move_home
...
class MoveHome(metaclass=Metaclass_MoveHome):
    from dsr_msgs2.srv._move_home import MoveHome_Request as Request
    from dsr_msgs2.srv._move_home import MoveHome_Response as Response
