...
class Metaclass_GetCurrentSolutionSpace(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dsr_msgs2.srv.GetCurrentSolutionSpace')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dsr_msgs2.srv import _get_current_solution_space
...
class GetCurrentSolutionSpace(metaclass=Metaclass_GetCurrentSolutionSpace):
    from dsr_msgs2.srv._get_current_solution_space import GetCurrentSolutionSpace_Request as Request
    from dsr_msgs2.srv._get_current_solution_space import GetCurrentSolutionSpace_Response as Response
