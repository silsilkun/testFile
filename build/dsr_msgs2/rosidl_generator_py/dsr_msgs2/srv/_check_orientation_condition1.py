...
class Metaclass_CheckOrientationCondition1(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dsr_msgs2.srv.CheckOrientationCondition1')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dsr_msgs2.srv import _check_orientation_condition1
...
class CheckOrientationCondition1(metaclass=Metaclass_CheckOrientationCondition1):
    from dsr_msgs2.srv._check_orientation_condition1 import CheckOrientationCondition1_Request as Request
    from dsr_msgs2.srv._check_orientation_condition1 import CheckOrientationCondition1_Response as Response
