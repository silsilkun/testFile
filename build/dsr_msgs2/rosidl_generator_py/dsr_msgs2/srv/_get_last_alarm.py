...
class GetLastAlarm_Response(metaclass=Metaclass_GetLastAlarm_Response):
    ...
    _fields_and_field_types = {
        'log_alarm': 'dsr_msgs2/LogAlarm',
        'success': 'boolean',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['dsr_msgs2', 'msg'], 'LogAlarm'),  # noqa: E501
...
class Metaclass_GetLastAlarm(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _get_last_alarm
...
class GetLastAlarm(metaclass=Metaclass_GetLastAlarm):
    from dsr_msgs2.srv._get_last_alarm import GetLastAlarm_Request as Request
    from dsr_msgs2.srv._get_last_alarm import GetLastAlarm_Response as Response
