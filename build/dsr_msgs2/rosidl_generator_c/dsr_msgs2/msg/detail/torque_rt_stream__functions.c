...
dsr_msgs2__msg__TorqueRtStream__create()
{
  ...
  dsr_msgs2__msg__TorqueRtStream * msg = (dsr_msgs2__msg__TorqueRtStream *)allocator.allocate(sizeof(dsr_msgs2__msg__TorqueRtStream), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dsr_msgs2__msg__TorqueRtStream));
  bool success = dsr_msgs2__msg__TorqueRtStream__init(msg);
  if (!success) {
...
dsr_msgs2__msg__TorqueRtStream__destroy(dsr_msgs2__msg__TorqueRtStream * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dsr_msgs2__msg__TorqueRtStream__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dsr_msgs2__msg__TorqueRtStream__Sequence__init(dsr_msgs2__msg__TorqueRtStream__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dsr_msgs2__msg__TorqueRtStream * data = NULL;

  if (size) {
    data = (dsr_msgs2__msg__TorqueRtStream *)allocator.zero_allocate(size, sizeof(dsr_msgs2__msg__TorqueRtStream), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dsr_msgs2__msg__TorqueRtStream__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dsr_msgs2__msg__TorqueRtStream__fini(&data[i - 1]);
      }
...
dsr_msgs2__msg__TorqueRtStream__Sequence__fini(dsr_msgs2__msg__TorqueRtStream__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dsr_msgs2__msg__TorqueRtStream__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dsr_msgs2__msg__TorqueRtStream__Sequence * array = (dsr_msgs2__msg__TorqueRtStream__Sequence *)allocator.allocate(sizeof(dsr_msgs2__msg__TorqueRtStream__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dsr_msgs2__msg__TorqueRtStream__Sequence__init(array, size);
  if (!success) {
...
dsr_msgs2__msg__TorqueRtStream__Sequence__destroy(dsr_msgs2__msg__TorqueRtStream__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dsr_msgs2__msg__TorqueRtStream__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dsr_msgs2__msg__TorqueRtStream__Sequence__are_equal(const dsr_msgs2__msg__TorqueRtStream__Sequence * lhs, const dsr_msgs2__msg__TorqueRtStream__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dsr_msgs2__msg__TorqueRtStream__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dsr_msgs2__msg__TorqueRtStream__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dsr_msgs2__msg__TorqueRtStream);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dsr_msgs2__msg__TorqueRtStream * data =
      (dsr_msgs2__msg__TorqueRtStream *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dsr_msgs2__msg__TorqueRtStream__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dsr_msgs2__msg__TorqueRtStream__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dsr_msgs2__msg__TorqueRtStream__copy(
