...
#include "dsr_msgs2/msg/detail/jog_multi_axis__rosidl_typesupport_fastrtps_c.h"
...
using _JogMultiAxis__ros_msg_type = dsr_msgs2__msg__JogMultiAxis;
...
size_t get_serialized_size_dsr_msgs2__msg__JogMultiAxis(
  const void * untyped_ros_message,
...
static uint32_t _JogMultiAxis__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dsr_msgs2__msg__JogMultiAxis(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsr_msgs2
size_t max_serialized_size_dsr_msgs2__msg__JogMultiAxis(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dsr_msgs2__msg__JogMultiAxis;
    is_plain =
      (
...
static size_t _JogMultiAxis__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dsr_msgs2__msg__JogMultiAxis(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, msg, JogMultiAxis)() {
