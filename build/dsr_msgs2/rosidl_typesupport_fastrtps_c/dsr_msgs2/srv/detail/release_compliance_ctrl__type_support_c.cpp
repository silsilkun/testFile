...
#include "dsr_msgs2/srv/detail/release_compliance_ctrl__rosidl_typesupport_fastrtps_c.h"
...
using _ReleaseComplianceCtrl_Request__ros_msg_type = dsr_msgs2__srv__ReleaseComplianceCtrl_Request;
...
size_t get_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Request(
  const void * untyped_ros_message,
...
static uint32_t _ReleaseComplianceCtrl_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsr_msgs2
size_t max_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dsr_msgs2__srv__ReleaseComplianceCtrl_Request;
    is_plain =
      (
...
static size_t _ReleaseComplianceCtrl_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, ReleaseComplianceCtrl_Request)() {
...
using _ReleaseComplianceCtrl_Response__ros_msg_type = dsr_msgs2__srv__ReleaseComplianceCtrl_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsr_msgs2
size_t get_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ReleaseComplianceCtrl_Response__ros_msg_type * ros_message = static_cast<const _ReleaseComplianceCtrl_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsr_msgs2
size_t max_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dsr_msgs2__srv__ReleaseComplianceCtrl_Response;
    is_plain =
      (
...
static size_t _ReleaseComplianceCtrl_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dsr_msgs2__srv__ReleaseComplianceCtrl_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, ReleaseComplianceCtrl_Response)() {
...
// already included above
// #include "dsr_msgs2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dsr_msgs2/srv/release_compliance_ctrl.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, ReleaseComplianceCtrl)() {
