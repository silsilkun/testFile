...
#include "dsr_msgs2/srv/detail/get_desired_posj__rosidl_typesupport_fastrtps_c.h"
...
using _GetDesiredPosj_Request__ros_msg_type = dsr_msgs2__srv__GetDesiredPosj_Request;
...
size_t get_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetDesiredPosj_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsr_msgs2
size_t max_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dsr_msgs2__srv__GetDesiredPosj_Request;
    is_plain =
      (
...
static size_t _GetDesiredPosj_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, GetDesiredPosj_Request)() {
...
using _GetDesiredPosj_Response__ros_msg_type = dsr_msgs2__srv__GetDesiredPosj_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsr_msgs2
size_t get_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetDesiredPosj_Response__ros_msg_type * ros_message = static_cast<const _GetDesiredPosj_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsr_msgs2
size_t max_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dsr_msgs2__srv__GetDesiredPosj_Response;
    is_plain =
      (
...
static size_t _GetDesiredPosj_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dsr_msgs2__srv__GetDesiredPosj_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, GetDesiredPosj_Response)() {
...
// already included above
// #include "dsr_msgs2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dsr_msgs2/srv/get_desired_posj.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, GetDesiredPosj)() {
