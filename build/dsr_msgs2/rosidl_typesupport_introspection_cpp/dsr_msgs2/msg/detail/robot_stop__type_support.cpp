...
{
  new (message_memory) dsr_msgs2::msg::RobotStop(_init);
}

void RobotStop_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dsr_msgs2::msg::RobotStop *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotStop_message_member_array[1] = {
  {
    ...
    offsetof(dsr_msgs2::msg::RobotStop, stop_mode),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotStop_message_members = {
  ...
  1,  // number of fields
  sizeof(dsr_msgs2::msg::RobotStop),
...
{
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::RobotStop_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, msg, RobotStop)() {
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::RobotStop_message_type_support_handle;
}
