...
{
  new (message_memory) dsr_msgs2::msg::LogAlarm(_init);
}

void LogAlarm_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dsr_msgs2::msg::LogAlarm *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LogAlarm_message_member_array[4] = {
  {
    ...
    offsetof(dsr_msgs2::msg::LogAlarm, level),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dsr_msgs2::msg::LogAlarm, group),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dsr_msgs2::msg::LogAlarm, index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(dsr_msgs2::msg::LogAlarm, param),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::LogAlarm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, msg, LogAlarm)() {
  return &::dsr_msgs2::msg::rosidl_typesupport_introspection_cpp::LogAlarm_message_type_support_handle;
}
