...
#include "dsr_msgs2/msg/detail/torque_rt_stream__type_support.h"
...
static const _TorqueRtStream_type_support_symbol_names_t _TorqueRtStream_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, msg, TorqueRtStream)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsr_msgs2, msg, TorqueRtStream)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dsr_msgs2, msg, TorqueRtStream)() {
  return &::dsr_msgs2::msg::rosidl_typesupport_c::TorqueRtStream_message_type_support_handle;
}
