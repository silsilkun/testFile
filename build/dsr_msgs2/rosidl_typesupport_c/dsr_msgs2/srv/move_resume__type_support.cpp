...
#include "dsr_msgs2/srv/detail/move_resume__type_support.h"
...
static const _MoveResume_Request_type_support_symbol_names_t _MoveResume_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, MoveResume_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsr_msgs2, srv, MoveResume_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dsr_msgs2, srv, MoveResume_Request)() {
  return &::dsr_msgs2::srv::rosidl_typesupport_c::MoveResume_Request_message_type_support_handle;
}
...
static const _MoveResume_Response_type_support_symbol_names_t _MoveResume_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, MoveResume_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsr_msgs2, srv, MoveResume_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dsr_msgs2, srv, MoveResume_Response)() {
  return &::dsr_msgs2::srv::rosidl_typesupport_c::MoveResume_Response_message_type_support_handle;
}
...
static const _MoveResume_type_support_symbol_names_t _MoveResume_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, MoveResume)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsr_msgs2, srv, MoveResume)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dsr_msgs2, srv, MoveResume)() {
  return &::dsr_msgs2::srv::rosidl_typesupport_c::MoveResume_service_type_support_handle;
}
