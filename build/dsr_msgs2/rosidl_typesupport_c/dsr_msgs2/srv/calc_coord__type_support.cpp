...
#include "dsr_msgs2/srv/detail/calc_coord__type_support.h"
...
static const _CalcCoord_Request_type_support_symbol_names_t _CalcCoord_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, CalcCoord_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsr_msgs2, srv, CalcCoord_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dsr_msgs2, srv, CalcCoord_Request)() {
  return &::dsr_msgs2::srv::rosidl_typesupport_c::CalcCoord_Request_message_type_support_handle;
}
...
static const _CalcCoord_Response_type_support_symbol_names_t _CalcCoord_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, CalcCoord_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsr_msgs2, srv, CalcCoord_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dsr_msgs2, srv, CalcCoord_Response)() {
  return &::dsr_msgs2::srv::rosidl_typesupport_c::CalcCoord_Response_message_type_support_handle;
}
...
static const _CalcCoord_type_support_symbol_names_t _CalcCoord_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsr_msgs2, srv, CalcCoord)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsr_msgs2, srv, CalcCoord)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dsr_msgs2, srv, CalcCoord)() {
  return &::dsr_msgs2::srv::rosidl_typesupport_c::CalcCoord_service_type_support_handle;
}
