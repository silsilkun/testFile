...
static const _RobotDisconnection_type_support_symbol_names_t _RobotDisconnection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, msg, RobotDisconnection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, msg, RobotDisconnection)),
  }
};
...
get_message_type_support_handle<dsr_msgs2::msg::RobotDisconnection>()
{
  return &::dsr_msgs2::msg::rosidl_typesupport_cpp::RobotDisconnection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, msg, RobotDisconnection)() {
  return get_message_type_support_handle<dsr_msgs2::msg::RobotDisconnection>();
}
