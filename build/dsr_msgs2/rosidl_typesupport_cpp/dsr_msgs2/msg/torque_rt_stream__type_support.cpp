...
static const _TorqueRtStream_type_support_symbol_names_t _TorqueRtStream_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, msg, TorqueRtStream)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, msg, TorqueRtStream)),
  }
};
...
{
  return &::dsr_msgs2::msg::rosidl_typesupport_cpp::TorqueRtStream_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, msg, TorqueRtStream)() {
  return get_message_type_support_handle<dsr_msgs2::msg::TorqueRtStream>();
}
