...
bool dsr_msgs2__msg__servoj_rt_stream__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dsr_msgs2.msg._servoj_rt_stream.ServojRtStream", full_classname_dest, 46) == 0);
  }
  dsr_msgs2__msg__ServojRtStream * ros_message = _ros_message;
  {  // pos
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dsr_msgs2__msg__servoj_rt_stream__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ServojRtStream */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dsr_msgs2.msg._servoj_rt_stream");
  ...
  dsr_msgs2__msg__ServojRtStream * ros_message = (dsr_msgs2__msg__ServojRtStream *)raw_ros_message;
  {  // pos
    PyObject * field = NULL;
