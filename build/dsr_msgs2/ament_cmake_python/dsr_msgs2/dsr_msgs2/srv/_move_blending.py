...
class Metaclass_MoveBlending(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _move_blending
...
class MoveBlending(metaclass=Metaclass_MoveBlending):
    from dsr_msgs2.srv._move_blending import MoveBlending_Request as Request
    from dsr_msgs2.srv._move_blending import MoveBlending_Response as Response
