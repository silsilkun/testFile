...
class GetToolForce_Response(metaclass=Metaclass_GetToolForce_Response):
    ...
    def __init__(self, **kwargs):
        ...
        if 'tool_force' not in kwargs:
            ...
            self.tool_force = kwargs.get('tool_force')
...
class Metaclass_GetToolForce(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _get_tool_force
...
class GetToolForce(metaclass=Metaclass_GetToolForce):
    from dsr_msgs2.srv._get_tool_force import GetToolForce_Request as Request
    from dsr_msgs2.srv._get_tool_force import GetToolForce_Response as Response
