...
class Metaclass_SetUserCartCoord2(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dsr_msgs2.srv.SetUserCartCoord2')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dsr_msgs2.srv import _set_user_cart_coord2
...
class SetUserCartCoord2(metaclass=Metaclass_SetUserCartCoord2):
    from dsr_msgs2.srv._set_user_cart_coord2 import SetUserCartCoord2_Request as Request
    from dsr_msgs2.srv._set_user_cart_coord2 import SetUserCartCoord2_Response as Response
