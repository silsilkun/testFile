...
class AlignAxis2_Request(metaclass=Metaclass_AlignAxis2_Request):
    ...
    def __init__(self, **kwargs):
        ...
        if 'target_vect' not in kwargs:
            ...
            self.target_vect = kwargs.get('target_vect')
        if 'source_vect' not in kwargs:
            self.source_vect = numpy.zeros(3, dtype=numpy.float64)
        else:
            self.source_vect = kwargs.get('source_vect')
...
class Metaclass_AlignAxis2(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dsr_msgs2.srv import _align_axis2
...
class AlignAxis2(metaclass=Metaclass_AlignAxis2):
    from dsr_msgs2.srv._align_axis2 import AlignAxis2_Request as Request
    from dsr_msgs2.srv._align_axis2 import AlignAxis2_Response as Response
