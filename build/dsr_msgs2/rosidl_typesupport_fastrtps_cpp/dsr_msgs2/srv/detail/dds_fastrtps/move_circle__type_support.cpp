...
#include "dsr_msgs2/srv/detail/move_circle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dsr_msgs2::srv::MoveCircle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dsr_msgs2::srv::MoveCircle_Request & ros_message)
{
  // Member: pos
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dsr_msgs2::srv::MoveCircle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dsr_msgs2::srv::MoveCircle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dsr_msgs2::srv::MoveCircle_Request *>(
    untyped_ros_message);
...
{
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_MoveCircle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveCircle_Request)() {
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_MoveCircle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dsr_msgs2
cdr_serialize(
  const dsr_msgs2::srv::MoveCircle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dsr_msgs2::srv::MoveCircle_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dsr_msgs2::srv::MoveCircle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dsr_msgs2::srv::MoveCircle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dsr_msgs2::srv::MoveCircle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_MoveCircle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveCircle_Response)() {
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_MoveCircle_Response__handle;
}
...
{
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_MoveCircle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveCircle)() {
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_MoveCircle__handle;
}
