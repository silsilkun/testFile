...
#include "dsr_msgs2/srv/detail/set_accj_rt__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dsr_msgs2::srv::SetAccjRt_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dsr_msgs2::srv::SetAccjRt_Request & ros_message)
{
  // Member: acc
  {
    cdr >> ros_message.acc;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dsr_msgs2::srv::SetAccjRt_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dsr_msgs2::srv::SetAccjRt_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dsr_msgs2::srv::SetAccjRt_Request *>(
    untyped_ros_message);
...
{
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_SetAccjRt_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, SetAccjRt_Request)() {
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_SetAccjRt_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dsr_msgs2
cdr_serialize(
  const dsr_msgs2::srv::SetAccjRt_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dsr_msgs2::srv::SetAccjRt_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dsr_msgs2::srv::SetAccjRt_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dsr_msgs2::srv::SetAccjRt_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dsr_msgs2::srv::SetAccjRt_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_SetAccjRt_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, SetAccjRt_Response)() {
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_SetAccjRt_Response__handle;
}
...
{
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_SetAccjRt__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, SetAccjRt)() {
  return &dsr_msgs2::srv::typesupport_fastrtps_cpp::_SetAccjRt__handle;
}
