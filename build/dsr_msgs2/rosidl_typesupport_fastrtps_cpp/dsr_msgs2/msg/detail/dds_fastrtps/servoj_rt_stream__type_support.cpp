...
#include "dsr_msgs2/msg/detail/servoj_rt_stream__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dsr_msgs2::msg::ServojRtStream;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dsr_msgs2::msg::ServojRtStream *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dsr_msgs2::msg::ServojRtStream *>(
    untyped_ros_message);
...
{
  return &dsr_msgs2::msg::typesupport_fastrtps_cpp::_ServojRtStream__handle;
}
