...
#include "dsr_msgs2/msg/detail/servoj_stream__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dsr_msgs2::msg::ServojStream & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dsr_msgs2::msg::ServojStream & ros_message)
{
  // Member: pos
  {
    cdr >> ros_message.pos;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dsr_msgs2::msg::ServojStream;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dsr_msgs2::msg::ServojStream *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dsr_msgs2::msg::ServojStream *>(
    untyped_ros_message);
...
{
  return &dsr_msgs2::msg::typesupport_fastrtps_cpp::_ServojStream__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, msg, ServojStream)() {
  return &dsr_msgs2::msg::typesupport_fastrtps_cpp::_ServojStream__handle;
}
