...
class RobotController(Node):
    ...
    def __init__(self, config: Optional[RobotConfig] = None):
        ...
        # DR_init 설정
        import DR_init
        DR_init.__dsr__id = self.config.robot_id
        DR_init.__dsr__model = self.config.robot_model
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            self.gripper = GripperController(node=self, namespace=self.config.robot_id)
